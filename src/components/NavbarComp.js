...
import BannerAttachments from "../pages/BannerAttachments";
    ...
    <Router>
      <div>
        <Routes>      
          ...
          {((agent) && <Route exact path = "/agentTracking" element = {<ProtectedRoute><Sidebar/><Topbar/> <AgentTracking/></ProtectedRoute>}/>)}
