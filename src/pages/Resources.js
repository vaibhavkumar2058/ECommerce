...
export default function Resourcess() {
  ...
  const columns = [
    ...
    { dataField: 'firstName', text: 'FirstName', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    { dataField: 'middleName', text: 'MiddleName', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    { dataField: 'lastName', text: ' LastName', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    ...
    { dataField: 'mobileNumber', text: 'MobileNumber', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    { dataField: 'addressId', text: 'Address', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    { dataField: 'bloodGroup', text: 'BloodGroup', sort: true, headerStyle: () => {
      return { width: "150px" };
    } },
    { dataField: 'email', text: 'Email', sort: true, headerStyle: () => {
      return { width: "150px" };
    } },
    { dataField: 'password', text: 'Password', sort: true , headerStyle: () => {
      return { width: "150px" };
    }},
    { dataField: 'isEmailVerified', text: 'IsEmailVerified', sort: true, headerStyle: () => {
      return { width: "150px" };
    } },
...
console.log("Keerthana");
      const dataFormatter = (rawData) => {
        ...
        curedData.fileName=rawData?.resourcesId?.fileName;
        curedData.middleName=rawData?.resourcesId?.middleName;
        curedData.lastName=rawData?.resourcesId?.lastName;
        curedData.role = rawData?.role?.roleName;
        curedData.gender = rawData?.gender?.genderName;
        curedData.mobileNumber=rawData?.resourcesId?.mobileNumber;
