...
export default function MeasurementTypes() {
  ...
  const handleEdit = (rowId, row) => {
    setMeasurementType(row);
    //getMeasurementTypesById(rowId);
    setId(rowId);
    setIsEdit(true);
    setShow(true);
  ...
  const getMeasurementTypeById = async (id) => {
    ...
    if (response.payload.title == "Success") {
      ...
      setMessageStatus({
        mode: 'danger',
        message: 'MeasurementType Get Failed.'
      })
    }
  };
  ...
  return (
    <>
      <div className="m-t-40">
        ...
        {measurementTypes && (<div>
          <ToolkitProvider
            bootstrap4
            keyField='measurementTypeId'
          ...
          >
            ...
            <Modal.Body>
              <MeasurementTypeModel
                onAddMeasurementType={addMeasurementType}
                onUpdateMeasurementType={updateMeasurementType}
                onDeleteMeasurementType={deleteMeasurementType}
                onGetMeasurementType={measurementTypeById}
                onClose={handleClose}
                isEdit={isEdit}
                isDelete={isDelete}
                id={id}
